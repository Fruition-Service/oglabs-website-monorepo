...
export const metadata: Metadata = {
  ...
  description: "Deep custom integrations connecting your sales and operations stack.",
}
...
export default function Page() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">Advanced Integrations</h1>
      <p className="mt-4 text-lg text-muted">Deep custom integrations connecting your sales and operations stack.</p>
      ...
      <div className="mt-12 grid gap-8 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-ui bg-surface-subtle p-8">
          <h2 className="text-xl font-semibold">Why OG Labs for Advanced Integrations?</h2>
